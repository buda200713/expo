...
// 👉 BADILISHA HAPA na Firebase yako mwenyewe
const firebaseConfig = {
  apiKey: "WEKA_HAPA_API_KEY_YAKO",
  authDomain: "WEKA_HAPA_AUTH_DOMAIN",
  projectId: "WEKA_HAPA_PROJECT_ID",
  storageBucket: "WEKA_HAPA_STORAGE_BUCKET",
  messagingSenderId: "WEKA_HAPA_MSG_SENDER_ID",
  appId: "WEKA_HAPA_APP_ID"
};
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, padding: 10, marginVertical: 10, borderRadius: 5, flex: 1 },
  inputRow: { flexDirection: 'row', padding: 10, alignItems: 'center' },
  msg: { backgroundColor: '#f1f1f1', padding: 10, marginVertical: 5, borderRadius: 10 }
});
title: Reference
hideTOC: true
---
